...
// extern var declarations.  replace these with local (non extern) for unit testing
//
extern int psw_N;
extern int psw_Z;
extern int psw_V;
...
// unit testing: place Set functions for PSW here



////////////////////////////////////////////////////////////////////
//	 single_exec():
//		Once an instruction is decoded and determined to be a
//		single operand instruction, the struct containing the individual
//		field values are passed to this function for processing.
//		There are 3 main parts:
//			get the operand value (reg/effective address)
//			perform the operation, update PSW bits
//			write back operand (except for TST)
//
////////////////////////////////////////////////////////////////////
